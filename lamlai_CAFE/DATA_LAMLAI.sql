...
AS
	...
	IF(@ISFIRSTTABLEEMPTY = 0)
		UPDATE TABLEFOOD SET STATUSTABLE = N'Trống' where idtablefood = @IDTABLE2

	IF(@ISSECONDTABLEEMPTY = 0)
		UPDATE TABLEFOOD SET STATUSTABLE = N'Trống' where idtablefood = @IDTABLE1
	...
	INSERT INTO NHANVIEN (MANV,TENDANGNHAP ,TENHIENTHI,PASS,TYPENV,EMAIL) VALUES (1,N'A1',N'NHIEN',1,1,'thaibaohaonhien1995@gmail.com')


	SELECT * FROM NHANVIEN WHERE EMAIL = 'thaibaohaonhien1995@gmail.com'
